...
export type DayData = {
  ...
  weight?: number;
  weightTime?: number;
  photos?: any[]; // lightweight photo meta list
...
const defaultDay = (dateKey: string): DayData => ({ date: dateKey, pills: { morning: false, evening: false }, drinks: { water: 0, coffee: 0, slimCoffee: false, gingerGarlicTea: false, waterCure: false, sport: false }, xpToday: {}, activityLog: [], photos: [] });
